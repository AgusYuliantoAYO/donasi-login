...
<div class="container-fluid">
    ...
    <body onload="window.print()">
        ...
        <tr>
            ...
            <tr>
                <td class="bg-dark text-white" colspan="7" align="right">Omset Kotor</td>
        ...
        <tr>
            ...
            <td align="left"> <b class="alert-warning">Rp. <?php echo number_format($donasi,0,',','.') ?></b></td>
            <td align="left">(2% dari Total Pendapatan omset)</td>
        </tr>
        <br>
        <tr>
            <td align="left">Omset Bersih :</td>
            <td align="left"> <b class="alert-success">Rp. <?php echo number_format($omsetBersih,0,',','.') ?></b></td>
        </tr>

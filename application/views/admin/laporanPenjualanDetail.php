    ...
    <div align="center">
        <div class="row ml-5">
            ...
            <div class="card text-success border-success shadow mb-3" style="max-width: 20rem;">
                    ...
                    Laporan <i>Sales</i> by <b>Tanggal</b>
                </div>
                        <!-- <h3 class="card-text"> <b>Orang Baik</b></h3> -->
                        <form action="<?= base_url();?>admin/filterPrdkDet" method="POST" target='_blank'>
            ...
            <div class="card text-success border-success shadow mb-3" style="max-width: 20rem;">
                    <div class="card-body ">
                    <div class="card-header bg-success text-white ">
                    Laporan <i>Sales</i> by <b>Bulan</b>
                </div>
            ...
            <div class="card text-success border-success shadow mb-3" style="max-width: 20rem;">
                    <div class="card-body">
                    <div class="card-header bg-success text-white ">
                    Laporan <i>Sales</i> by <b>Tahun</b>
                </div>

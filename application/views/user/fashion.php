...
<div class="container-fluid">
    ...
    <div class="col-md-12" align="center">
        <div class="row mt-3">
            ...
            <div class="col-3">
                <a class="btn btn-outline-success active" href="<?php echo base_url('user/fashion') ?>">
...
<ol class="breadcrumb float-sm-left mb-2 mr-5" style="background: #F5F5F5;">
    ...
    <li class="breadcrumb-item active"><small><a
                href="http://localhost/donasi-login/user/fashion"><b>Fashion</b></a></small>
        <!-- <li class="breadcrumb-item "><a href="#">Dashboard</a></li> -->
</ol> 
<div class="row text-center mt-3">
    <?php foreach ($fashion as $nd): ?>
